...
// function does not check size
void
array_with_parameter_size (int n, int a[n])
{
  struct S *b = a;
...
void
size_constrained (int a[static 4])
{
  struct S *b = a;
...
// function does not check size
void
indirect_size_constrained (int a[static 2])
{
  struct S *b = a;
...
// function does not check size
void
pointer_to_array_n (int n, int (*a)[n])
{
  struct S *b = a;
...
// a is int (*a)[1]
void
indirect_pointer_to_array (int (*a)[1])
{
  struct S *b = a;
...
main ()
{
  ...
  // If your function has an array argument, consider the length specifications as comments rather than type
  // declarations.
  printf ("============================================\n");
