...
main()
{
  ...
  int dim0 = sizeof C;
  int dim1 = sizeof C       / sizeof C[0];       // 12 / 6 = 2
  int dim2 = sizeof C[0]    / sizeof C[0][0];    //  6 / 3 = 2
  int dim3 = sizeof C[0][0] / sizeof C[0][0][0]; //  3 / 1 = 3
  ...
  // ===========================================================================================================================================
  int(*second_dim_p)[3] = (int(*)[3])C;                     // here type is different from underlying type -> we need an explicit cast for C
