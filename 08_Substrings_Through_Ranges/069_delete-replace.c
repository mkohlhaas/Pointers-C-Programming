...
{
  {
    ...
    print_substr(res); printf(" # "); print_substr(z);
    putchar('\n');
    ...
    print_substr(res); printf(" # "); print_substr(x);
    putchar('\n');
...

  {
    ...
    print_substr(res); printf(" # "); print_substr(out); // fooquxbaz # fooquxbazqux
    putchar('\n');
  }

  {
    ...
    print_substr(z); printf(" -> ");
    Substr res = replace_substr(out, z, x, y);
    print_substr(res); printf(" # "); print_substr(out); // fooXbaz # fooXbazazqux
    putchar('\n');
  }

  {
    ...
    print_substr(z); printf(" -> ");
    Substr res = replace_substr(out, z, x, y);
    print_substr(res); printf(" # "); print_substr(out); // fooXXXXbaz # fooXXXXazqux
    putchar('\n');
  }

  {
    ...
    print_substr(res); printf(" # "); print_substr(z); // fooqaxbazqux # fooqaxbazqux
