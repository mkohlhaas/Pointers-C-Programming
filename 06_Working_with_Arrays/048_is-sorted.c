...
bool
is_sorted(void const* array, size_t len, size_t obj_size, CompareFN cmp)
{
  for (int i = 1; i < len; i++) {
...
{
  {
    ...
    if   (is_sorted(int_array, int_array_length, sizeof *int_array, int_compare))               printf("int_array    is sorted\n");
    else                                                                                        printf("int_array    is not sorted\n");
...

  {
    ...
    if   (is_sorted(string_array, string_array_length, sizeof *string_array, string_compare))   printf("string_array is sorted\n");
    else                                                                                        printf("string_array is not sorted\n");
