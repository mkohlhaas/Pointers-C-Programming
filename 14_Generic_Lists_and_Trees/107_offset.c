...
void print_dlink(DLink *link) { printf("%d", link->value); }

void print_forward(Link *link) { print_dlink(container(link, DLink, forward_link)); }

void print_backward(Link *link) { print_dlink(container(link, DLink, backward_link)); }
...
void free_forward(Link *link) { free_dlink(container(link, DLink, forward_link)); }

void free_backward(Link *link) { free_dlink(container(link, DLink, backward_link)); }
