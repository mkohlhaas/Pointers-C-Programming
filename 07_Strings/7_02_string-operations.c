...
char *string_copy1(char *output, char const *input) {
  char const *x = input;
  char *y = output;
  for (; *x; x++, y++) {
    *y = *x;
...
char *string_copy2(char *output, char const *input) {
  while (*input) {
    *output++ = *input++;
  }
  *output = '\0';
...
char *string_copy3(char *output, char const *input) {
...
char *string_copy4(char *output, char const *input) {
  while ((*output++ = *input++)) // copies also `0`
    ;
  return output;
}
...
char *string_copy5(char *output, const char *input) {
  do {
