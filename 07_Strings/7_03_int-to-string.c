...
// Precondition: `n` < 0
void neg_int_to_string1(int n, char *s) {
...
void int_to_string1(int n, char *s) {
  if (n == 0) {
    s[0] = '0';
    s[1] = '\0';
    return;
...
char *neg_int_to_string3(int n, char *s) {
  char const *digits = "0123456789";
  if (n <= -10) {
...
void int_to_string3(int n, char *s) {
  if (n == 0) {
    s[0] = '0';
    s[1] = '\0';
    return;
...
void neg_int_to_string4(int n, char **s) {
  char const *digits = "0123456789";
  if (n <= -10) {
...
void int_to_string4(int n, char *s) {
  if (n == 0) {
    s[0] = '0';
    s[1] = '\0';
    return;
